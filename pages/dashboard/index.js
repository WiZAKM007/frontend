...
export async function getServerSideProps() {
  const res = await fetch('https://frontend-nine-jade-32.vercel.app/api/users')
...
const handleDelete = async (id) => {
   console.log("ID : ", id);
fetch('https://frontend-nine-jade-32.vercel.app/api/users?id=' + id, {
  method: 'DELETE',
})
...
<br></br>
        ...
        <div className="container">
          ...
          <div align="right">  <Link className="btn btn-success text-n" href="dashboard/user/add/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
